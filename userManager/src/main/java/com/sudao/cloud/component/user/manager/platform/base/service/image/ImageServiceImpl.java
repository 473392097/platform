...
import com.sudao.cloud.component.user.manager.platform.base.service.compressor.DefaultImageCompressor;
import com.sudao.cloud.component.user.manager.platform.base.service.compressor.ImageCompressor;
...
public class ImageServiceImpl extends BaseServiceImpl implements ImageService {
    ...
    public ImageServiceImpl() throws IOException {
        //获取存放图片的根目录位置
        String root = envProperties.get("filestorage.root");
